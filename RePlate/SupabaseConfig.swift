...
//  2. Build. Then use the global `supabase` client below from your services/view models.
//
...
/// Shared Supabase client. Use this everywhere (auth, database, storage, realtime).
